...
export default class extends Component {
    ...
    renderDays() {
        ...
        for (i = 0; i < startWeekDay; i++) {
            ...
            days.push(<Tappable key={'p' + i} onTap={this.selectDay.bind(this, dy, dm, d)}
                                className="day in-previous-month">{d}</Tappable>);
        }
        ...
        for (i = 1; i <= daysInMonth; i++) {
            ...
            days.push(<Tappable key={i} onTap={this.selectDay.bind(this, displayYear, displayMonth, i)}
                                className={cssClass}>{i}</Tappable>);
        }
        ...
        for (i = 1; i <= 42 - c; i++) {
            ...
            days.push(<Tappable key={'n' + i} onTap={this.selectDay.bind(this, dy, dm, i)}
                                className="day in-next-month">{i}</Tappable>);
        }
