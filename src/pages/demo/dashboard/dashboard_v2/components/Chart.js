...
export default () => {
    return (
        <div className="card direct-chat direct-chat-warning direct-chat-contacts-open">
            ...
            <div className="card-body display_block">
            ...
            <div className="card-footer display_block">
