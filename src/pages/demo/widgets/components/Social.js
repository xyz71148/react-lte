                   ...
                   <div className="card card-widget">
                       ...
                       <div className="card-footer card-comments">
                           <div className="card-comment">
                               <img className="img-circle img-sm" src="static/dist/img/user3-128x128.jpg" alt="User Image"/>
                    ...
                    <span className="username">
                      ...
                      <span className="text-muted float-right">8:03 PM Today</span>
                           ...
                           <div className="card-comment">
                               <img className="img-circle img-sm" src="static/dist/img/user4-128x128.jpg" alt="User Image"/>
                               <div className="comment-text">
                    <span className="username">
                      Luna Stark
                      <span className="text-muted float-right">8:03 PM Today</span>
                   ...
                   <div className="card card-widget">
                       ...
                       <div className="card-body">
                           ...
                           <div className="attachment-block clearfix">
                               <img className="attachment-img" src="static/dist/img/photo1.png" alt="Attachment Image"/>
                    ...
                    <span className="username">
                      ...
                      <span className="text-muted float-right">8:03 PM Today</span>
                           ...
                           <div className="card-comment">
                               <img className="img-circle img-sm" src="static/dist/img/user5-128x128.jpg" alt="User Image"/>
                               <div className="comment-text">
                    <span className="username">
                      Nora Havisham
                      <span className="text-muted float-right">8:03 PM Today</span>
