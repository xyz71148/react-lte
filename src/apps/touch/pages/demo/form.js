                ...
                <Container scrollable={scrollable}>
                    {/*<UI.Group>
                            ...
                            <UI.GroupBody>
                                <UI.Item>
                                    <UI.ItemInner>
                                        ...
                                        <UI.Switch onTap={this.handleSwitch.bind(this, 'switchValue')}
                                                   on={this.state.switchValue}/>
                                    </UI.ItemInner>
                                </UI.Item>
                                <UI.Item>
                                    <UI.ItemInner>
                        ...
                        <UI.Group>
                            ...
                            <UI.GroupBody>
                                <UI.RadioList value={this.state.flavourRadioList}
                                              onChange={this.handleRadioListChange.bind(this, 'flavourRadioList')}
                                              options={FLAVOURS}/>
                            </UI.GroupBody>
                        </UI.Group>
                        <UI.Group>
                        ...
                        <UI.Group>
                            ...
                            <UI.GroupBody>
                                ...
                                <UI.LabelInput noedit label="No Edit"
                                               defaultValue="Un-editable, scrollable, selectable content"/>
                                <UI.LabelSelect label="Flavour" value={this.state.flavourLabelSelect}
                                                onChange={this.handleLabelSelectChange.bind(this, 'flavourLabelSelect')}
                                                options={FLAVOURS}/>
                            </UI.GroupBody>
                        </UI.Group>
