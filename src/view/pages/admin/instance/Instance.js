...
(class extends Component {
    ...
    onShowField(field) {
        this.setState({
            fieldValue: field === "services" ? JSON.stringify(this.props.row[field]) : this.props.row[field]
        })
        this.props.dispatch({
            type: "route/showPage",
            payload: {
                    ...
                    <Cells>
                        {
                            (row && fields) && Object.keys(fields).map(field=>{
                                ...
                                if(["ovpn_config"].includes(field)) return null;                            
                                const value = field === "services" ? JSON.stringify(row[field]) : row[field]
                                return (
